"use client";
import { ArrowLeft, Eye, Github, Instagram, Linkedin, Twitter } from "lucide-react";
      ...
      >
        <div className="container flex flex-row-reverse items-center justify-between p-6 mx-auto">
          <div className="flex justify-between gap-8">
            ...
            <Link target="_blank" href="https://www.linkedin.com/in/annisa-u-273a6a259/">
              <Linkedin
            ...
            <Link target="_blank" href="https://github.com/annisaurohmah">
              <Github
                className={`w-6 h-6 duration-200 hover:font-medium ${
                  isIntersecting
                    ? " text-zinc-400 hover:text-zinc-100"
